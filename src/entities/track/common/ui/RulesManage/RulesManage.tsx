        ...
        const defaultRules = [
          ...
          },
          {
            ...
            conditions: [
              ...
              { field: 'participants', operator: 'includes', value: `ml.lmtech@${process.env.COMPANY_DOMAIN}`, logic: 'OR' as const },
              { field: 'participants', operator: 'includes', value: `ml.all.co@${process.env.COMPANY_DOMAIN}`, logic: 'OR' as const },
              { field: 'participants', operator: 'includes', value: `ml.all.dir@${process.env.COMPANY_DOMAIN}`, logic: 'OR' as const },
              { field: 'participants', operator: 'includes', value: `allrd@${process.env.COMPANY_DOMAIN}`, logic: 'OR' as const },
              { field: 'participants', operator: 'includes', value: `ml.co@${process.env.COMPANY_DOMAIN}`, logic: 'OR' as const },
              { field: 'participants', operator: 'includes', value: `ml.com@${process.env.COMPANY_DOMAIN}`, logic: 'OR' as const },
              { field: 'participants', operator: 'includes', value: `Products@${process.env.COMPANY_DOMAIN}`, logic: 'OR' as const },
              {
                field: 'participants',
                operator: 'includes',
