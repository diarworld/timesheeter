...
import { ISunAndMoonAnimatedSvgProps, ThemeMode } from 'entities/track/common/ui/DarkModeSwitch/types';
...
export const SunAndMoonAnimatedSvg = ({
  ...
  const darkColors = {
    ...
    leftBeamStroke: isSystemThemeModeEnabled ? systemColors.leftBeamStroke : lightColors.leftBeamStroke,
    rightBeamStroke: isSystemThemeModeEnabled ? systemColors.rightBeamStroke : lightColors.rightBeamStroke,
  };
  ...
  return (
    ...
    >
      ...
      <mask id={leftSemiCircleMaskId}>
        {themeMode !== ThemeMode.Dark && <rect x="0" y="0" width="51%" height="100%" fill="white" />}
      ...
      <mask id={rightSemiCircleMaskId}>
        {themeMode !== ThemeMode.Dark && <rect x="50%" y="0" width="50%" height="100%" fill="white" />}
        {themeMode === ThemeMode.Dark && (
          <>
            <rect x="0" y="0" width="100%" height="100%" fill="white" />
          </>
      ...
      <animated.g style={linesProps}>
        {/* Beam Left side */}
        <animated.line x1="4.22" y1="19.78" x2="5.64" y2="18.36" stroke={themeColorsProps.leftBeamStroke} />
        <animated.line x1="1" y1="12" x2="3" y2="12" stroke={themeColorsProps.leftBeamStroke} />
        <animated.line x1="4.22" y1="4.22" x2="5.64" y2="5.64" stroke={themeColorsProps.leftBeamStroke} />
        {/* Beam Right side */}
        <animated.line x1="18.36" y1="5.64" x2="19.78" y2="4.22" stroke={themeColorsProps.rightBeamStroke} />
        <animated.line x1="21" y1="12" x2="23" y2="12" stroke={themeColorsProps.rightBeamStroke} />
        <animated.line x1="18.36" y1="18.36" x2="19.78" y2="19.78" stroke={themeColorsProps.rightBeamStroke} />
      </animated.g>
    </animated.svg>
  );
};
