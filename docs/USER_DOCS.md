...
Сервис создан для упрощения ведения учета трудозатрат по задачам в Yandex Tracker. Его основная цель — **капитализация усилий сотрудников по продуктам и проектам**, а не просто формальная фиксация времени. Это необходимо компании (ЛМЦТ) для корректного выставления счетов в сторону Лемана Про и получения налоговых льгот.
...
* Или нажмите **Добавить трек (Add new track)**.
...
* Или напишите в чат TG @diarworld .
